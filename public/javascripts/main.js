  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      $(data.skills).each(function(index, info) {
        ...
        let skillProgressBar = `<div class='marginbottom marginright widthProgressBar slide-up'>
      ...
      $(data.projects).each(function(index, info) {
        ...
        let projectContainer = `
                    <div class='marginbottom d-flex align-items-start flex-column'>
                        ...
                        <div class='maxTagsWith d-flex flex-wrap'>
                            ${newLanguage}
                        </div>
                    </div>`;
        ...
        if (active === true) {
          ...
          $("#activeCheck").html(
            `<span style="color: red;" class="boldthick">Active:</span> ${title}`
          );
        } else {
          $("#finishedProjects").prepend(projectContainer);
        }
